...
complete -c oma -n "__fish_oma_using_subcommand remove" -l autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand del" -l autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand rm" -l autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand purge" -l autoremove -d 'Auto remove unnecessary package(s)'
