...
complete -c oma -n "__fish_oma_using_subcommand install" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand add" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand remove" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand del" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand rm" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand autoremove" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand provides" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand provides" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand fix-broken" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand pick" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand tui" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand purge" -l no-fix-dpkg-status -d 'Do not fix dpkg broken status'
...
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "install" -d 'Install package(s) from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "upgrade" -d 'Upgrade packages installed on the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "download" -d 'Download package(s) from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "remove" -d 'Remove the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "refresh" -d 'Refresh repository metadata/catalog'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "show" -d 'Show information on the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "search" -d 'Search for package(s) available from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "files" -d 'List files in the specified package'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "provides" -d 'Search for package(s) that provide(s) certain patterns in a path'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "fix-broken" -d 'Resolve broken system dependencies in the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "pick" -d 'Install specific version of a package'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "mark" -d 'Mark status for one or multiple package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "list" -d 'List package(s) available from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "depends" -d 'Lists dependencies of one or multiple packages'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "rdepends" -d 'List reverse dependency(ies) for the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "clean" -d 'Clear downloaded package cache'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "history" -d 'Show a history/log of package changes in the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "undo" -d 'Undo system changes operation'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "tui" -d 'Oma tui interface'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "topics" -d 'Manage testing topics enrollment'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "mirror" -d 'Manage Mirrors enrollment'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "purge" -d 'purge (like apt purge) the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "command-not-found" -d 'command-not-found'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "pkgnames" -d 'Pkgnames (used for completion)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "generate" -d 'Generate shell completions and manpages'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files provides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
