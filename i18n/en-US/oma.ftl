...
psa-installed-window = Installed packages (count: { $count }, total size: { $size })
psa-remove-window = Remove pending ({ $count } packages, size: { $size })
psa-autoremove = Autoremove packages
