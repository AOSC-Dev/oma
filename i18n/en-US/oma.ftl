...
tum-2 = { $update } package will be { $updated }, { $install } will be { $installed }, { $reinstall } will be { $reinstalled }, { $remove } will be { $removed }, { $downgrade } will be { $downgraded }.
tum-3 = The list of specific component changes is as follows:
