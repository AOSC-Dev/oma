...
cnf-install-tip-similar = Tip: you can install the package listed above with oma install <package name>; to view all packages providing similarly named commands, use oma provides --bin { $query }
