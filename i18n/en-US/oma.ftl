...
clap-usage = Usage
clap-about = User-friendly and performant package manager for APT repositories
...
clap-remove-help = Remove the specified package(s)
clap-refresh-help = Refresh repository metadata/catalog
...
clap-provides-help = Search for package(s) that provide(s) certain patterns in a path
clap-fixbroken-help = Resolve broken dependencies in the system
clap-pick-help = Install specific version of a package
clap-mark-help = Mark status for one or multiple package(s)
clap-depends-help = Lists dependencies of one or multiple packages
clap-rdepends-help = List reverse dependency(ies) for the specified package(s)
clap-clean-help = Clear downloaded package cache
clap-history-help = Show a history/log of package changes in the system
clap-undo-help = undo system changes operation
clap-tui-help = oma TUI interface
clap-version-help = Print version
clap-topics-help = Manage testing topics enrollment
clap-mirror-help = Manage Mirrors enrollment
clap-size-analyzer-help = Packages size analyzer
clap-tree-help = Display a tree visualization of a dependency graph
clap-why-help = Why package is installed
clap-version-help = Print version

# clap: generic options
clap-apt-options-help = Set apt options
clap-autoremove-help = Auto remove unnecessary package(s)
clap-color-help = Represents the color preferences for program output
clap-debug-help = Run oma with debug output
clap-download-threads-help = Setup download threads (default as 4)
clap-dry-run-help = Run oma in "dry-run" mode
clap-dry-run-long-help = Useful for testing changes and operations without making changes to the system
clap-fix-broken-help = Resolve broken dependencies in the system
clap-follow-terminal-color-help = Output result with terminal theme color
clap-force-confnew-help = Replace configuration file(s) in the system those shipped in the package(s) to be installed (invokes `dpkg --force-confnew`)
clap-force-unsafe-io-help = Install package(s) without fsync(2)
clap-force-yes-help = Ignore repository and package dependency issues
clap-install-dbg-help = Install debug symbol package
clap-install-recommends-help = Install recommended package(s)
clap-install-suggests-help = Install suggested package(s)
clap-json-help = Set output format as JSON
clap-no-autoremove-help = Do not auto remove unnecessary package(s)
clap-no-bell-help = Don't ring if oma completes the transaction
clap-no-check-battery-help = Run oma do not check battery status
clap-no-check-dbus-help = Run oma do not check dbus
clap-no-fixbroken-help = Do not fix apt broken status
clap-no-fix-dpkg-status-help = Do not fix dpkg broken status
...
clap-no-pager-help = Output result to stdout, not pager
clap-no-progress-help = Do not display progress bar
clap-no-refresh-help = Do not refresh repository metadata
clap-no-refresh-topics-help = Do not refresh topics manifest.json file
clap-no-remove-help = Do not allow removal of packages during upgrade (like `apt upgrade')
clap-no-take-wake-lock-help = Run oma do not take wake lock
clap-packages-value-name = PACKAGES
clap-reinstall-help = Reinstall package(s)
clap-remove-config-help = Remove package(s) also remove configuration file(s), like apt purge
clap-sysroot-help = Set sysroot target directory
...
clap-command-not-found-keyword-help = Package to query command-not-found
clap-contents-find-bin-help = Search binary of package(s)
clap-contents-find-package-help = Package to display a list files of
clap-depends-packages-help = Package(s) to query dependency(ies) for
clap-download-packages-help = Package(s) to download
clap-download-path-help = The path where package(s) should be downloaded to
clap-install-packages-help = Package(s) to install
clap-list-packages-help = Package(s) to list
clap-list-all-help = List all available version(s) of (a) package(s) from all repository(ies)
clap-list-installed-help = List only package(s) currently installed on the system
clap-list-upgradable-help = List only package(s) with update(s) available
clap-list-manually-installed-help = List only package(s) with manually installed
clap-list-automatic-help = List only package(s) with automatic installed
clap-list-autoremovable-help = List only package(s) with autoremovable
clap-list-hold-help = List only package(s) with hold
clap-mark-long-help = Mark status for one or multiple package(s), oma will resolve dependencies in accordance with the marked status(es) of the specified package(s)
clap-mark-packages-help = Package(s) to mark status for
clap-mirror-set-help = Set mirror(s) to sources.list
clap-mirror-set-names-help = Enable mirror name(s)
clap-mirror-add-help = Add mirror(s) to sources.list
clap-mirror-add-names-help = Add mirror name(s)
clap-mirror-remove-help = Remove mirror(s) from sources.list
clap-mirror-remove-names-help = Remove mirror name(s)
clap-mirror-sort-mirrors-help = Sort mirror(s) order
clap-mirror-speedtest-help = Speedtest mirror(s)
clap-mirror-speedtest-set-fastest-help = Also set fastest as mirror
clap-pick-package-help = Package to pick specific version for
clap-rdepends-help = Package(s) to query reverse dependency(ies) for
clap-remove-packages-help = Package(s) to remove
clap-purge-packages-help = Package(s) to remove and purge configurations
clap-search-pattern-help = Keywords to search
clap-show-all-help = Show information on all available version(s) of (a) package(s) from all repository(ies)
clap-show-packages-help = Package(s) to show
clap-size-analyzer-details-help = Only display packages size details
clap-topics-all-help = Display all topics on list (include draft status topics)
clap-topics-opt-in-help = Enroll in one or more topic(s), delimited by space
clap-topics-opt-out-help = Withdraw from one or more topic(s) and rollback to stable versions, delimited by space
clap-topics-always-write-status-help = Always write status to atm file and sources.list
clap-topics-only-apply-sources-list-help = Only apply topics change to sources list file, not apply system change
clap-topics-yes-long-help = Note that this parameter depends on the `--opt-out` or `--opt-in` parameter, otherwise it is invalid.
clap-tree-packages-help = Query Package(s) name
clap-tree-reverse-help = Invert the tree direction and focus on the given package
clap-tree-depth-help = Maximum display depth of the dependency tree
clap-why-packages-help = Query Package(s) name
clap-why-depth-help = Maximum display depth of the dependency tree