...
_oma() {
    ...
    case "${cmd}" in
        ...
        oma__clean)
            ...
            ;;
        oma__depends)
            opts="-h --debug --no-color --no-progress --no-check-dbus --sysroot --help <packages>..."
            if [[ ${cur} == -* ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        oma__download)
            opts="-p -h --path --debug --no-color --no-progress --no-check-dbus --sysroot --help <packages>..."
            if [[ ${cur} == -* ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        oma__history)
            ...
            ;;
        oma__install)
            opts="-y -h --install-dbg --reinstall --install-recommends --install-suggests --no-install-recommends --no-install-suggests --no-fix-broken --no-refresh --yes --force-yes --force-confnew --dry-run --dpkg-force-all --debug --no-color --no-progress --no-check-dbus --sysroot --help [packages]..."
            if [[ ${cur} == -* ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        oma__mark)
            ...
            ;;
        oma__pick)
            opts="-h --dry-run --debug --no-color --no-progress --no-check-dbus --sysroot --help hold unhold manual auto <packages>..."
            if [[ ${cur} == -* ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        oma__provides)
            ...
            ;;
        oma__purge)
            opts="-y -h --yes --force-yes --no-autoremove --dry-run --debug --no-color --no-progress --no-check-dbus --sysroot --help <packages>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        oma__search)
            ...
            ;;
        oma__show)
            opts="-a -h --all --debug --no-color --no-progress --no-check-dbus --sysroot --help <packages>..."
            if [[ ${cur} == -* ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        oma__undo)
            ...
            ;;
        oma__upgrade)
            opts="-y -h --yes --force-yes --force-confnew --dry-run --dpkg-force-all --debug --no-color --no-progress --no-check-dbus --sysroot --help [packages]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
