...
cnf-install-tip-similar = Tip: you can install the package listed above with oma install <package name>, or use oma provides --bin { $query } to see all packages providing similarly named commands.
