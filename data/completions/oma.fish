...
function __fish_oma_global_optspecs
	string join \n dry-run debug color= follow-terminal-color no-progress no-check-dbus v/version sysroot= apt-options= h/help
end
...
complete -c oma -n "__fish_oma_needs_command" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_needs_command" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_needs_command" -f -a "prvides" -d 'Search for package(s) that provide(s) certain patterns in a path'
complete -c oma -n "__fish_oma_needs_command" -f -a "fix-broken" -d 'Resolve broken system dependencies in the system'
...
complete -c oma -n "__fish_oma_using_subcommand install" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand install" -l no-install-recommends -d 'Do not install recommend package(s)'
complete -c oma -n "__fish_oma_using_subcommand install" -l no-install-suggests -d 'Do not install recommend package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand install" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand install" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand add" -l no-install-recommends -d 'Do not install recommend package(s)'
complete -c oma -n "__fish_oma_using_subcommand add" -l no-install-suggests -d 'Do not install recommend package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand add" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand add" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand upgrade" -s n -l no-fixbroken -d 'Do not fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand upgrade" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand full-upgrade" -s n -l no-fixbroken -d 'Do not fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand full-upgrade" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand download" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand remove" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand remove" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand remove" -l no-autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand remove" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand del" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand del" -l no-autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand del" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand rm" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand rm" -l no-autoremove -d 'Auto remove unnecessary package(s)'
...
complete -c oma -n "__fish_oma_using_subcommand rm" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand refresh" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand show" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand info" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand info" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand search" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand search" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand files" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand files" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand prvides" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
complete -c oma -n "__fish_oma_using_subcommand prvides" -l sysroot -d 'Set sysroot target directory' -r -F
complete -c oma -n "__fish_oma_using_subcommand prvides" -l apt-options -d 'Set apt options' -r
complete -c oma -n "__fish_oma_using_subcommand prvides" -l bin -d 'Search binary of package(s)'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l no-pager -l println -d 'Output result to stdout, not pager'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l debug -d 'Run oma with debug output'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l follow-terminal-color -d 'Output result with terminal theme color'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l no-progress -d 'Do not display progress bar'
complete -c oma -n "__fish_oma_using_subcommand prvides" -l no-check-dbus -d 'Run oma do not check dbus'
complete -c oma -n "__fish_oma_using_subcommand prvides" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c oma -n "__fish_oma_using_subcommand fix-broken" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand fix-broken" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand pick" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mark" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand list" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand list" -s a -l automatic -d 'List only package(s) with automatic installed'
complete -c oma -n "__fish_oma_using_subcommand list" -s a -l autoremovable -d 'List only package(s) with autoremovable'
complete -c oma -n "__fish_oma_using_subcommand list" -l json -d 'Set output format as JSON'
complete -c oma -n "__fish_oma_using_subcommand list" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand depends" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand depends" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand dep" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand dep" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand rdepends" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand rdepends" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand rdep" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand rdep" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand history" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand log" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand log" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand undo" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand undo" -s n -l no-fixbroken -d 'Do not fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand undo" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand tui" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand topics" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand topics" -s n -l no-fixbroken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand topic" -s n -l no-fixbroken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand topic" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and not __fish_seen_subcommand_from set add remove sort-mirrors speedtest help" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from set" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from set" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from add" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from add" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from remove" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from remove" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from sort-mirrors" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from sort-mirrors" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from speedtest" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirror; and __fish_seen_subcommand_from speedtest" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and not __fish_seen_subcommand_from set add remove sort-mirrors speedtest help" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and not __fish_seen_subcommand_from set add remove sort-mirrors speedtest help" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from set" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from set" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from add" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from add" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from remove" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from remove" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from sort-mirrors" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from sort-mirrors" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from speedtest" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand mirrors; and __fish_seen_subcommand_from speedtest" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand purge" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand purge" -s f -l fix-broken -d 'Fix apt broken status'
...
complete -c oma -n "__fish_oma_using_subcommand purge" -l no-autoremove -d 'Auto remove unnecessary package(s)'
complete -c oma -n "__fish_oma_using_subcommand purge" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand command-not-found" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand pkgnames" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand pkgnames" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand generate; and not __fish_seen_subcommand_from shell man help" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand generate; and not __fish_seen_subcommand_from shell man help" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand generate; and __fish_seen_subcommand_from shell" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand generate; and __fish_seen_subcommand_from shell" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand generate; and __fish_seen_subcommand_from man" -l color -d 'Represents the color preferences for program output' -r -f -a "{auto\t'',always\t'',never\t''}"
...
complete -c oma -n "__fish_oma_using_subcommand generate; and __fish_seen_subcommand_from man" -l dry-run -d 'Run oma in “dry-run” mode. Useful for testing changes and operations without making changes to the system'
...
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "install" -d 'Install package(s) from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "upgrade" -d 'Upgrade packages installed on the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "download" -d 'Download package(s) from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "remove" -d 'Remove the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "refresh" -d 'Refresh repository metadata/catalog'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "show" -d 'Show information on the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "search" -d 'Search for package(s) available from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "files" -d 'List files in the specified package'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "prvides" -d 'Search for package(s) that provide(s) certain patterns in a path'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "fix-broken" -d 'Resolve broken system dependencies in the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "pick" -d 'Install specific version of a package'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "mark" -d 'Mark status for one or multiple package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "list" -d 'List package(s) available from the repository'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "depends" -d 'Lists dependencies of one or multiple packages'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "rdepends" -d 'List reverse dependency(ies) for the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "clean" -d 'Clear downloaded package cache'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "history" -d 'Show a history/log of package changes in the system'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "undo" -d 'Undo system changes operation'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "tui" -d 'Oma tui interface'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "topics" -d 'Manage testing topics enrollment'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "mirror" -d 'Manage Mirrors enrollment'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "purge" -d 'purge (like apt purge) the specified package(s)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "command-not-found" -d 'command-not-found'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "pkgnames" -d 'Pkgnames (used for completion)'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "generate" -d 'Generate shell completions and manpages'
complete -c oma -n "__fish_oma_using_subcommand help; and not __fish_seen_subcommand_from install upgrade download remove refresh show search files prvides fix-broken pick mark list depends rdepends clean history undo tui topics mirror purge command-not-found pkgnames generate help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
