 ...
 * **Uncategorized**
    - Update all deps ([`4fa16e6`](https://github.com/AOSC-Dev/aoscpt/commit/4fa16e6cd6a604943ba6e1ce94090dfbb3f24389))
    - Oma search if strsim score is 1000 (max) display 'full match' ([`9be10e8`](https://github.com/AOSC-Dev/aoscpt/commit/9be10e84ba8467d0e83297e32f02481d5af318e6))
    - Max terminal len limit to 150 ([`90584ac`](https://github.com/AOSC-Dev/aoscpt/commit/90584ac6a1f1f07a93d27355df0928563dc593ce))
    - Oma download success display downloaded package count ([`5930c32`](https://github.com/AOSC-Dev/aoscpt/commit/5930c328df228c92a1dd5249324ed44c3e68fbe5))
    - Oma list only installed version display installed ([`e6ffcd5`](https://github.com/AOSC-Dev/aoscpt/commit/e6ffcd566c2dda829546e40ba578b0c678b4aaf6))
    - Oma list glob support ([`b78cb13`](https://github.com/AOSC-Dev/aoscpt/commit/b78cb133db492371ffa625f6c4e00d98c3671564))
    - Always lowercase search word ([`ad119c5`](https://github.com/AOSC-Dev/aoscpt/commit/ad119c514dd8b8de069086681732c8f0825af522))
    - Ignore case search word and pkg description ([`6b681b4`](https://github.com/AOSC-Dev/aoscpt/commit/6b681b4cc1c417dc7a6b38b1de6f20b715adbe9c))
    - No need to unlock oma two twice ([`f251869`](https://github.com/AOSC-Dev/aoscpt/commit/f251869bd2d1529a859081fb7d680d74fa7a3f2d))
    - Use zlib-ng to improve performance ([`fa0efe5`](https://github.com/AOSC-Dev/aoscpt/commit/fa0efe5bc4fd0d995ce180ddf99f5d719713a065))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.38.2 ([`d84fb3e`](https://github.com/AOSC-Dev/aoscpt/commit/d84fb3ebf58f76fcf3f363b98639f0334bd90d93))
    - Use cargo-fmt to format code ([`0d99d40`](https://github.com/AOSC-Dev/aoscpt/commit/0d99d40254fbb946f43bb53ee140aeec2db9c1e0))
    - Try to flushing file add progress spinner again ([`f17b335`](https://github.com/AOSC-Dev/aoscpt/commit/f17b335d8c8d42878de1a042b733826a1a732f1d))
    - Try to flushing file add progress spinner ([`128b930`](https://github.com/AOSC-Dev/aoscpt/commit/128b93057a1002d5ddb7c8761359b53edc20ab90))
    - Use tokio::io::copy replaced tokio::fs::copy ([`ae9aa24`](https://github.com/AOSC-Dev/aoscpt/commit/ae9aa241f9e12ccec30e25ff84290c94d66edbe7))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.38.1 ([`5dca1fc`](https://github.com/AOSC-Dev/aoscpt/commit/5dca1fc5e6751484bb981714a303fdcd7de9348a))
    - Use cargo clippy to lint code ([`36acc15`](https://github.com/AOSC-Dev/aoscpt/commit/36acc15bf8a3e58c05f0b13696d6c9053a33c8e6))
    - Use cargo-fmt to format code ([`dfb0ea7`](https://github.com/AOSC-Dev/aoscpt/commit/dfb0ea73555f26f993b7dd9f61e95cd884459632))
    - Update all deps ([`ef92fe7`](https://github.com/AOSC-Dev/aoscpt/commit/ef92fe7328ad1a6df3f5cff77e1be7101b96d25e))
    - Download global bar reset position if checksum fail and not allow resume ([`94ac90d`](https://github.com/AOSC-Dev/aoscpt/commit/94ac90d9cf09580857daf85e39dccee1bb97d12f))
    - Fix mirror is updated oma refresh will checksum mismatch ([`e712031`](https://github.com/AOSC-Dev/aoscpt/commit/e712031bc4aa558dcc922d0878a0c8dcb877c766))
    - Half-configure do not mark pkg as reinstall status ([`8fe73f0`](https://github.com/AOSC-Dev/aoscpt/commit/8fe73f0cae9af09c11cff6e5a7a8875c2732c294))
    - Fetch local source inc global bar ([`019878f`](https://github.com/AOSC-Dev/aoscpt/commit/019878fdd7bc59745c54cd14a0a3cfb4365512af))
    - Copy file use fs::copy to improve preforence; use ProgressSpinner to display fetch local source progress ([`abea1ec`](https://github.com/AOSC-Dev/aoscpt/commit/abea1ec032fd8b654ce5d0d7ca365038d2790467))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.38.0 ([`1559648`](https://github.com/AOSC-Dev/aoscpt/commit/155964844709b5dc41624fbbb92c986952d0c9db))
    - Update all deps ([`9ea4973`](https://github.com/AOSC-Dev/aoscpt/commit/9ea49733edea7d73317b8fafb08b28b6978677dd))
    - Use cargo clippy to lint code ([`8a1b4b6`](https://github.com/AOSC-Dev/aoscpt/commit/8a1b4b6146d637c2954cd8888e2d2914c504a03b))
    - Use right method to get apt style source ([`6f79419`](https://github.com/AOSC-Dev/aoscpt/commit/6f7941995a45ed1b1efdaeb6b7e6082bb0feccc2))
    - Improve oma show APT-Source info output ([`f3b3181`](https://github.com/AOSC-Dev/aoscpt/commit/f3b31817a4b430a92c4dadbbf1236e62e83a6154))
    - Add more debug output for fetch local source ([`d4303a2`](https://github.com/AOSC-Dev/aoscpt/commit/d4303a272abb3dc854c84caec0767a9856ca0e2d))
    - Revert "feat: use current thread to fetch local source" ([`e854b81`](https://github.com/AOSC-Dev/aoscpt/commit/e854b81d182e27d714751ee83c072c245b8af780))
    - Use current thread to fetch local source ([`dbccc72`](https://github.com/AOSC-Dev/aoscpt/commit/dbccc7267b56ebf1cf87585c9eea0570e61fc0dd))
    - Fetch local source InRelease inc progress ([`e605c6b`](https://github.com/AOSC-Dev/aoscpt/commit/e605c6b57010dbdfbf221863b791248d84de6041))
    - Oma refresh progress bar inc ([`2ed87f6`](https://github.com/AOSC-Dev/aoscpt/commit/2ed87f681355f811c833d0b095b17ed38363cfcf))
    - Fix run decompress file ([`b793959`](https://github.com/AOSC-Dev/aoscpt/commit/b79395914912e2ff60a8a16d14708197f6b593d9))
    - Fetch local source do not uncompress in local source (from) directory ([`95c2ee6`](https://github.com/AOSC-Dev/aoscpt/commit/95c2ee6e565ea27ed1a6831bf2467e9c9fd7c61f))
    - Do not read buf all to memory in download_and_extract_db_local method ([`8d4d28c`](https://github.com/AOSC-Dev/aoscpt/commit/8d4d28cdcb512fb29f3a0700cccbdd167436e13e))
    - Fetch local source pkg use oma style progress bar ([`1f72ff0`](https://github.com/AOSC-Dev/aoscpt/commit/1f72ff0a44cd5c2bc16c71a2a311f82a0b9e5305))
    - Add fetch local source package progress bar ([`a4c0f68`](https://github.com/AOSC-Dev/aoscpt/commit/a4c0f68dd5bfe43b28fbedc448f03bfb71c3fda6))
    - Add some update database debug message ([`a505125`](https://github.com/AOSC-Dev/aoscpt/commit/a5051258c2bcb5e022ce20333ccc40ac8916b0fd))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.37.1 ([`3c3ccc0`](https://github.com/AOSC-Dev/aoscpt/commit/3c3ccc061e6500f19999886214f7485e47b5491d))
    - Fix fetch local source database filename ([`cfebaf5`](https://github.com/AOSC-Dev/aoscpt/commit/cfebaf569cf561905ff1d96971932c9c25074d0d))
    - Check file is exist in download_and_extract_db_local ([`798fe79`](https://github.com/AOSC-Dev/aoscpt/commit/798fe7964960f61ac876635b3dce5eb080e77cc2))
    - Fix fetch local source database file ([`cc6f289`](https://github.com/AOSC-Dev/aoscpt/commit/cc6f289d9072db61c724bf9b9c5dc70765981cb5))
    - Use cargo fmt to format code ([`d103963`](https://github.com/AOSC-Dev/aoscpt/commit/d1039634ba86a8c45e3ba3bb617269d792482467))
    - Use cargo clippy to lint code ([`7a9a1c1`](https://github.com/AOSC-Dev/aoscpt/commit/7a9a1c1b8ae48e1f56704c2b2802a52dc079cb22))
    - Update all deps ([`6af62b0`](https://github.com/AOSC-Dev/aoscpt/commit/6af62b0cbd78e1132ffb03ef58c91b395bd840ff))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.37.0 ([`ec53fdc`](https://github.com/AOSC-Dev/aoscpt/commit/ec53fdc10cb8335b5192c873be481123f823db06))
    - Improve try_download error output ([`8c5b1a8`](https://github.com/AOSC-Dev/aoscpt/commit/8c5b1a88f5d8830a6406aabbe0b5b82699e74557))
    - Cli::writeln do not output next empty line ([`1ee0b2f`](https://github.com/AOSC-Dev/aoscpt/commit/1ee0b2f9ead57f2056a8d9271cd9c82ec0ce4d22))
    - More precise handling of IOError in the try_download function ([`d5f6aef`](https://github.com/AOSC-Dev/aoscpt/commit/d5f6aef89ab7ca0b5fc4fedad1100e66dfe7ab0a))
    - Improve download dir not exist error output ([`ca7099a`](https://github.com/AOSC-Dev/aoscpt/commit/ca7099ab7129afdee76927cc30680c7fb8e68b11))
    - Fix run oma install --install-dbg ([`cd2ba53`](https://github.com/AOSC-Dev/aoscpt/commit/cd2ba53f198d2dcacdf4f8c9cd32848a02078067))
    - Tips user virtual package didn't mark ([`bdc2ecc`](https://github.com/AOSC-Dev/aoscpt/commit/bdc2ecced9900237bd461384c11d0344487fd331))
    - Fix run oma fix-broken ([`13c0a6f`](https://github.com/AOSC-Dev/aoscpt/commit/13c0a6fb168b3932b45a29d3a3c7fec9d757127b))
    - Do not display error to due_to in oma topics ([`baeea2a`](https://github.com/AOSC-Dev/aoscpt/commit/baeea2a82ab6c3370f011cbbc852cb4567cb10f5))
    - Search order move package to top if pkg.name == input and installed ([`95cf354`](https://github.com/AOSC-Dev/aoscpt/commit/95cf354f9b262eab3d19b69719eb35e89c3d705f))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.36.3 ([`975e78d`](https://github.com/AOSC-Dev/aoscpt/commit/975e78de0991c4391b1a1dcfa0230226bc08602d))
    - Abtsract error_due_to method ([`6338d51`](https://github.com/AOSC-Dev/aoscpt/commit/6338d51de8d189fac1d03c2b34373ff91b95e1bb))
    - Update rust-apt version and adapt it ([`53bf31b`](https://github.com/AOSC-Dev/aoscpt/commit/53bf31b428bc6565b0063a2a340d5c70b6df2e2c))
    - Use error_due_to function to easily handle the due_to case ([`cdc9c38`](https://github.com/AOSC-Dev/aoscpt/commit/cdc9c38dd30339ae8a34a2df89df3bdc9ae06eef))
    - Error and due_to to right order ([`e2bf48b`](https://github.com/AOSC-Dev/aoscpt/commit/e2bf48b14a67e3637fec635e15d02dad4c858458))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.36.2 ([`8def847`](https://github.com/AOSC-Dev/aoscpt/commit/8def847aaa956305fb0ad2aac765b5a42489b927))
    - Use cargo clippy and fmt to lint code ([`61bf476`](https://github.com/AOSC-Dev/aoscpt/commit/61bf4767f4a6b6df3ea9ebeba2d53d9e9b638b36))
    - Do not decompress BinContents ([`e886c87`](https://github.com/AOSC-Dev/aoscpt/commit/e886c87864ba235145c9e0da6b4d10458de1f7b8))
    - Try_download return error display due_to ([`aaeb44e`](https://github.com/AOSC-Dev/aoscpt/commit/aaeb44e15374f85b942f332598a673f980312d6f))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.36.1 ([`0e1f604`](https://github.com/AOSC-Dev/aoscpt/commit/0e1f604fd1dbd59d6ac1ca3aae7bb667465f631a))
 ...
 * **Uncategorized**
    ...
    - Add more error output in try_download method ([`9b21402`](https://github.com/AOSC-Dev/aoscpt/commit/9b214028c22feee75b09fd8195e01314ab4cc388))
    - Download success break loop in try_download method ([`866d89f`](https://github.com/AOSC-Dev/aoscpt/commit/866d89f6dddeaea3cf20b1af6e9575a44e78a64b))
    - This loop never actually loops in try_download method ([`98838f2`](https://github.com/AOSC-Dev/aoscpt/commit/98838f200b7a164813885f44b0792b56f45bd441))
    - Do not append decompress file ([`4343d1d`](https://github.com/AOSC-Dev/aoscpt/commit/4343d1dfe5a247ca96aa1a9159ebca8ecf5a3380))
    - Optimize try_download logic ([`8615f21`](https://github.com/AOSC-Dev/aoscpt/commit/8615f21c2ec8bee7e20b11926787240f95dec742))
    - Do not download package success download next package ([`eb87d41`](https://github.com/AOSC-Dev/aoscpt/commit/eb87d41fd058c579cac061007aa793fd2dd6a4d4))
 ...
 * **Uncategorized**
    - Bump oma v0.35.0 ([`1a9304f`](https://github.com/AOSC-Dev/aoscpt/commit/1a9304fa3212733f2b6ef6a3f4e453249a0cc121))
    - Use cargo-fmt to format code ([`71b844d`](https://github.com/AOSC-Dev/aoscpt/commit/71b844d32bdba7ed4df35e7de16c5e7e210ef5dc))
    - Set Config struct name as AptConfig ([`be95c59`](https://github.com/AOSC-Dev/aoscpt/commit/be95c599c7e36fe542e7b4aa3eebce602842d56c))
    - Fix force-yes, no-install-{recommends,suggests} argument ([`63c1c36`](https://github.com/AOSC-Dev/aoscpt/commit/63c1c36fc7ef11e594fbe5ef7818568e70d29c3a))
    - Add oma install --no-install-recommends and --no-install-suggests ([`5b2006a`](https://github.com/AOSC-Dev/aoscpt/commit/5b2006a1bf92580d6bb290752adb72aa5b02305a))
    - Recommend -> recommends, suggest -> suggests in oma install [ARGS] ([`aab59d4`](https://github.com/AOSC-Dev/aoscpt/commit/aab59d4c1e1ceef3fae33882db010ca25b6d4b3e))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.34.0 ([`4efff56`](https://github.com/AOSC-Dev/aoscpt/commit/4efff56490c77d138302ed39e6912a6fec9f1685))
    - Update all deps ([`2b270ae`](https://github.com/AOSC-Dev/aoscpt/commit/2b270aec994b01b0fbeb6a4948bde259528edc84))
    - Display command not found error if oma command-not-found no results found ([`426c6fc`](https://github.com/AOSC-Dev/aoscpt/commit/426c6fc1dd6b2a35e788860f5cb6a9d5b5c73af0))
    - Use cargo clippy and cargo fmt to lint code ([`da0655a`](https://github.com/AOSC-Dev/aoscpt/commit/da0655a4ffa0e845cec23c57d854e0675eb03c1f))
    - Oma install/remove/upgrade -y should display review message ([`84464c2`](https://github.com/AOSC-Dev/aoscpt/commit/84464c26a063e8c8188987af7e2162d39ddf30dc))
    - Add oma systemd service ([`eb2af81`](https://github.com/AOSC-Dev/aoscpt/commit/eb2af8149e62e5215eac88987bf3941eae3e4313))
    - Fix wrong oma pkgnames parameter name ... ([`9e56aca`](https://github.com/AOSC-Dev/aoscpt/commit/9e56acaa1fdbfbc33a2aa41c74d88e8da68ab92c))
    - No need to collect package list in oma list method ([`84e4ca4`](https://github.com/AOSC-Dev/aoscpt/commit/84e4ca451e167c79a44412790e2b128c353db8f0))
    - Support fish completion ([`e00e9cc`](https://github.com/AOSC-Dev/aoscpt/commit/e00e9ccbd7c99d9ff5e82a2412f3cc2db7366bb4))
    - Add shell competions feature ([`8b15ee1`](https://github.com/AOSC-Dev/aoscpt/commit/8b15ee13c5158f47b370feebe1dfd42fcb7b0b23))
    - Fetch database global progress bar overflow ([`9b1d8b9`](https://github.com/AOSC-Dev/aoscpt/commit/9b1d8b9d417ef81001391d8c59f99ef539902dce))
    - Retry 3 times, not 4 (again) ([`4c7174e`](https://github.com/AOSC-Dev/aoscpt/commit/4c7174e528ce117dd918acd5f5fbffa09d0ddee0))
    - Retry 3 times, not 4 ([`ee8c562`](https://github.com/AOSC-Dev/aoscpt/commit/ee8c562777b0e3d1c137d55432d10fdf84f836cb))
    - Apt_lock_inner failed do not retry ([`300c9a3`](https://github.com/AOSC-Dev/aoscpt/commit/300c9a3f9ebfbab4789db18c3e6fb53223cf99cc))
    - Optimize main logic ([`0de4fcd`](https://github.com/AOSC-Dev/aoscpt/commit/0de4fcd240c3f61bbcf89fe0bf5e6dc73e2fe6ec))
    - Add oma pkgnames for shell completion ([`0a1bcbb`](https://github.com/AOSC-Dev/aoscpt/commit/0a1bcbb270cd78804a3ae12c1ab615b4e62347fb))
    - Return 1 if oma show pkgs result is empty ([`91acc43`](https://github.com/AOSC-Dev/aoscpt/commit/91acc4314a7558aef5c9a4506e31f92a6417e2bb))
    - Oma args function return exit code ([`58e2913`](https://github.com/AOSC-Dev/aoscpt/commit/58e2913c9852074c040681d1dc6499f7c7e4bdb4))
    - Improve UI strings for oma pending ui output ([`73f1ce5`](https://github.com/AOSC-Dev/aoscpt/commit/73f1ce593b7fb4edcc4b9502cb7a147cbf63a821))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.33.1 ([`ddcffd4`](https://github.com/AOSC-Dev/aoscpt/commit/ddcffd4793c3cee84afbcb7d2fa259a7b77394b9))
    - Improve command-not-found directions ([`b0d14fb`](https://github.com/AOSC-Dev/aoscpt/commit/b0d14fb0897be29155859e6cfbe49a71d15e53b8))
    - Push missing fish command-not-found commit ([`070dd36`](https://github.com/AOSC-Dev/aoscpt/commit/070dd360a4a8c9b2a0d14bf1879f7a7383308aa8))
    - Oma command-not-found always return 127 ([`261d35a`](https://github.com/AOSC-Dev/aoscpt/commit/261d35a12a213af973ce914c0124e50d1c9a49b0))
    - License code under GPLv3 ([`22d449d`](https://github.com/AOSC-Dev/aoscpt/commit/22d449d555ff0b3e89cbfd9a8e4048df8d0e9b53))
    - Move PolicyKit rules to /data/policykit ([`9a540fe`](https://github.com/AOSC-Dev/aoscpt/commit/9a540fef0793c300c09efc7bbcd8f08320978bc5))
    - Add Shell integrations ([`6dd5327`](https://github.com/AOSC-Dev/aoscpt/commit/6dd5327f86955c1ebfd62ded1a85b96bffb5cd64))
    - Oma command-not-fould should return 127 ([`2b89d1c`](https://github.com/AOSC-Dev/aoscpt/commit/2b89d1c356d95c8be17f6f67f56abd2c7ee36739))
    - Improve UI strings for oma refresh output ([`cea6107`](https://github.com/AOSC-Dev/aoscpt/commit/cea61077fe0c70a327b3d644a3dacbb749a8b9fc))
    - Improve oma install --install-recommend and --install-suggest help message ([`3923169`](https://github.com/AOSC-Dev/aoscpt/commit/3923169a3183158ffbbc9fb98f466196dcbbb1db))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.33.0 ([`607dc68`](https://github.com/AOSC-Dev/aoscpt/commit/607dc681251588aa9653b302b657f4fc73cbb0ea))
    - Update all deps ([`b5faa67`](https://github.com/AOSC-Dev/aoscpt/commit/b5faa6722eac78f1075095c237fd743249ebd059))
    - Do not panic with display CJK message ([`34a190b`](https://github.com/AOSC-Dev/aoscpt/commit/34a190b4a53490e152ffac643e15130729238cde))
    - Revert "fix: do not panic with display CJK message" ([`f0da2c3`](https://github.com/AOSC-Dev/aoscpt/commit/f0da2c3ba1c2eed6227f562adc701a62a005c0e5))
    - No need to collect in search_pkgs method ([`f5a5571`](https://github.com/AOSC-Dev/aoscpt/commit/f5a557166d5d766fbd4bf59aa17006be7f77e3cd))
    - Use cargo clippy and cargo fmt to lint code ([`03ca22e`](https://github.com/AOSC-Dev/aoscpt/commit/03ca22e086e8c68dfb3cb0079a4682e19e7ce194))
    - Use Box to optimize logic in decompress method ([`478c2e8`](https://github.com/AOSC-Dev/aoscpt/commit/478c2e8c9145e6f8d9847358437d09f969ff444d))
    - Use BufReader to decompress package database ([`4f8da4a`](https://github.com/AOSC-Dev/aoscpt/commit/4f8da4aec365ed92e6cc9bb33e10b0bf71f94bdd))
    - Use BinContents to command-not-found feature ([`64d88bf`](https://github.com/AOSC-Dev/aoscpt/commit/64d88bf059bf7921b22caeeb947de9e71b7c1a54))
    - Revert "refactor: no need to download multi contents" ([`4e98e2f`](https://github.com/AOSC-Dev/aoscpt/commit/4e98e2fe3df4a934da6c51aa8e8ceefb314d0d52))
    - No need to download multi contents ([`d08e903`](https://github.com/AOSC-Dev/aoscpt/commit/d08e903866fe01e35b08272ed37b2096f3273a28))
    - No need to collect checksum entry to parse ([`86432a7`](https://github.com/AOSC-Dev/aoscpt/commit/86432a7f9f8a593136f1caabc416a5f647b3b81d))
    - Both contents-all and contents-ARCH must be downloaded ([`4cec322`](https://github.com/AOSC-Dev/aoscpt/commit/4cec322874e9fd46d467219a684a36036274802c))
    - Optmize search_pkgs filter logic ([`04133e0`](https://github.com/AOSC-Dev/aoscpt/commit/04133e0a6a734bc1170965a4fe837a4e2768c685))
    - Optmize search_pkgs filter logic again ([`bbee127`](https://github.com/AOSC-Dev/aoscpt/commit/bbee12732e7357b52c42fa89e07e07a4f613fb31))
    - Optmize search_pkgs filter logic ([`9296db3`](https://github.com/AOSC-Dev/aoscpt/commit/9296db314338057472951a87edc664c0f0cd87e5))
    - Update all deps ([`ebf8d73`](https://github.com/AOSC-Dev/aoscpt/commit/ebf8d735634625b2fc056b32d9fdae9716657858))
    - Use cargo-fmt and cargo-clippy to lint code ([`fe1d5ff`](https://github.com/AOSC-Dev/aoscpt/commit/fe1d5ffc83de72ca3eed03d9a7fe96f5be4c2ab7))
    - Add terminal bell if oma operation is done ([`2ee74ed`](https://github.com/AOSC-Dev/aoscpt/commit/2ee74ed227972b76ff061a788dae80db938ba72d))
    - Add query upgadable packages progress spinner ([`a50f65e`](https://github.com/AOSC-Dev/aoscpt/commit/a50f65ecd9e79cb5e012b0e2b7a2a6d08e50855c))
    - No need to collect upgrade package in update_inner method ([`01e8cfd`](https://github.com/AOSC-Dev/aoscpt/commit/01e8cfd45cb4602f80c06f427409b6dade1096ce))
    - Abstract install_other logic ([`50bca89`](https://github.com/AOSC-Dev/aoscpt/commit/50bca89128856e2c1cea464da64f924fea28e682))
    - Add more debug for download method ([`31634d3`](https://github.com/AOSC-Dev/aoscpt/commit/31634d3338ffadbb636cc0cde70a87617dac1120))
    - Oma install add --install-recommend and --install-suggest argument ([`b627c8a`](https://github.com/AOSC-Dev/aoscpt/commit/b627c8a0b3d9d2171223700e3243c12bb92d5de0))
    - Add more debug message for needs_fix_system method ([`a5e6e1f`](https://github.com/AOSC-Dev/aoscpt/commit/a5e6e1f8e349e17c5fc63f92c558423af9135577))
    - Handle if pkg current_state == 4 or 2 (half-install or half-configure) ([`537d428`](https://github.com/AOSC-Dev/aoscpt/commit/537d428c0902aa8661b8b3566b99931b248cf104))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.32.2 ([`6522355`](https://github.com/AOSC-Dev/aoscpt/commit/6522355b898ca9f1b48d6dfc5a8ddfe4a896aff9))
 ...
 * **Uncategorized**
    ...
    - Improve auto close topic ([`fed5365`](https://github.com/AOSC-Dev/aoscpt/commit/fed5365c2e4e84f8a1ebdb1d82d63425ac7f7aa5))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.30.0 ([`a556238`](https://github.com/AOSC-Dev/aoscpt/commit/a556238b6367af5a767e618feee54504a5249949))
    - Use cargo-fmt to lint code ([`df11fbc`](https://github.com/AOSC-Dev/aoscpt/commit/df11fbc07c64c57e263c130bcd4894eda1ac4fe4))
    - Do not save file with download failed; return error if 404 not found url is not closed topic ([`55d15ef`](https://github.com/AOSC-Dev/aoscpt/commit/55d15ef692f3781360552bfe8f0ecb7ee09b2063))
    - Don't let the progress spinner thread dead loop if the download has errors ([`9b424b8`](https://github.com/AOSC-Dev/aoscpt/commit/9b424b81b25c48ae12ab3158f713ef781afd83fe))
    - If package newest version in other enabled topics, downgrade to stable version ([`afeae4a`](https://github.com/AOSC-Dev/aoscpt/commit/afeae4adaa65585d307b7564b72d9a8c44319b6c))
    - Drop inquire searcher curosr ([`8c8f5e9`](https://github.com/AOSC-Dev/aoscpt/commit/8c8f5e97da8b1785637decc19c11b9dca73df0b8))
    - Drop inquire searcher ([`3244292`](https://github.com/AOSC-Dev/aoscpt/commit/324429279ff07a8e21e0656c3bef5165fe193036))
    - Use spawn_blocking to execute rm_topic method ([`7a208b7`](https://github.com/AOSC-Dev/aoscpt/commit/7a208b756c73cd6203dabeab7dcbac6f9adc7d97))
    - Update_db if url is closed topic, remove url from apt sources.list ([`70190fc`](https://github.com/AOSC-Dev/aoscpt/commit/70190fcae1c25683c6994749c7674dff4189a3c5))
    - Use cargo clippy to lint code again ([`df4fdf6`](https://github.com/AOSC-Dev/aoscpt/commit/df4fdf600828e6dc1256438c11544d4718e44431))
    - Use cargo clippy to lint code ([`67f2046`](https://github.com/AOSC-Dev/aoscpt/commit/67f20466321260f59b5769dec969ffd1888c7ced))
    - Update all deps ([`34c4013`](https://github.com/AOSC-Dev/aoscpt/commit/34c4013fbb3fd588355d66186291140b87c71195))
    - Add topics feature ([`46d340a`](https://github.com/AOSC-Dev/aoscpt/commit/46d340a2dea03cad8d9dac39ef75cdd0431bf92e))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.29.1 ([`f352de2`](https://github.com/AOSC-Dev/aoscpt/commit/f352de2d580318f67f00d015d83d76ccea34ecfb))
    - Update all deps ([`a29f795`](https://github.com/AOSC-Dev/aoscpt/commit/a29f7954eba270fc18e942eb5fca32c5458e6d0f))
    - Use cargo clippy to lint code ([`fe7979c`](https://github.com/AOSC-Dev/aoscpt/commit/fe7979ca1655af0df2ae7d11325ff1fb19bbd6df))
    - Improve download method logic ([`92b729e`](https://github.com/AOSC-Dev/aoscpt/commit/92b729efa537780bffa1cfc8e5a8e057bafa83c7))
    - Download doesn exist file will return error ([`47cdbc4`](https://github.com/AOSC-Dev/aoscpt/commit/47cdbc4ce8d5673ab60cd10490d999f185731e3c))
    - Not allow_resume file wrong reset length ([`9f5da29`](https://github.com/AOSC-Dev/aoscpt/commit/9f5da29cc0483cad628fcbeb881ca340f7637d91))
    - Remove useless refrence flag ([`000570b`](https://github.com/AOSC-Dev/aoscpt/commit/000570bb20ad22ad90515791b3202ed038548f36))
    - Check InRelaese date and vaild-until ([`aef283d`](https://github.com/AOSC-Dev/aoscpt/commit/aef283d66c4ac9be766762b54d60f97c16305693))
 ...
 * **Uncategorized**
    - Bump oma v0.29.0 ([`f0deeca`](https://github.com/AOSC-Dev/aoscpt/commit/f0deeca35c5453add4a8d9619c49eef13a4a2117))
    - Use trait to get prefix string ([`8507728`](https://github.com/AOSC-Dev/aoscpt/commit/8507728ae35419300d29fecea98f88ffca95dec8))
    - Sort oma search order, UPGRADE > AVAIL > INSTALLED ([`1fd75d9`](https://github.com/AOSC-Dev/aoscpt/commit/1fd75d92d95db04209a3216a00bb02c6b1d99de4))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.28.2 ([`a64057b`](https://github.com/AOSC-Dev/aoscpt/commit/a64057b13ee959091351f4b70eb8428b2dc71543))
    - Lint code use myself brain and cargo-clippy ([`55acee4`](https://github.com/AOSC-Dev/aoscpt/commit/55acee4afd11e703deb204fadda2c0e9bb179aee))
    - Command-not-found do not display progress spinner ([`71e0267`](https://github.com/AOSC-Dev/aoscpt/commit/71e0267e96cf3fd1bca19930ee4cb1f066dd2ea2))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.28.1 ([`850560b`](https://github.com/AOSC-Dev/aoscpt/commit/850560bdc9a091f5a320876fd0264b54dcb042ad))
    - Update all deps ([`cf50ed1`](https://github.com/AOSC-Dev/aoscpt/commit/cf50ed1f0cc0eb96e17c387a7f1bec80deb65371))
    - Fix-broken no need to do anything useless to run apt_install method ([`f140377`](https://github.com/AOSC-Dev/aoscpt/commit/f140377d12c0f06e533f77485f4b82889d434c24))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.28.0 ([`e69fcb6`](https://github.com/AOSC-Dev/aoscpt/commit/e69fcb677009026984ba2fb67eb5708328fd8bea))
    - Update h2 to v0.3.18 ([`5fb2dc4`](https://github.com/AOSC-Dev/aoscpt/commit/5fb2dc434dae4b7d4856b044f62b404c22560d69))
    - Check system needs fix status in oma {upgrade,fix-brokeen} ([`8d080aa`](https://github.com/AOSC-Dev/aoscpt/commit/8d080aa9d17f798ede44aaf6d2458ea3b1559de6))
    - Afixcurrent_state comment a typo ([`d8a38a3`](https://github.com/AOSC-Dev/aoscpt/commit/d8a38a37cd1b9afc1742d40e11a7e7bcd842c1c5))
    - Add current_state comment ([`9b929a8`](https://github.com/AOSC-Dev/aoscpt/commit/9b929a8ae679ea294ec66b74afcf3d5f18287380))
    - Check system needs fix status ([`d277409`](https://github.com/AOSC-Dev/aoscpt/commit/d277409c1c7edd8a24b4ca7f4ca9ad82bfdabd7d))
    - Oma download path maybe return error ([`d7473c4`](https://github.com/AOSC-Dev/aoscpt/commit/d7473c4b5f7d15d71cf19c18c7284340ae19e4b9))
    - Oma download do not display downloaded specific pkgs ([`f53dbb2`](https://github.com/AOSC-Dev/aoscpt/commit/f53dbb2dcf71972e25d8b3d3d8fc6cefd34ffcd5))
    - Update all deps ([`7ac3114`](https://github.com/AOSC-Dev/aoscpt/commit/7ac3114e8503b5e5127956bc8992012a59a9e30b))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.27.0 ([`6ca744e`](https://github.com/AOSC-Dev/aoscpt/commit/6ca744e471b9b110802eb8b0445f0814fbfdb3c8))
 ...
 * **Uncategorized**
    ...
    - If get ARCH run dpkg to failed, error missing context (2) ([`9160c24`](https://github.com/AOSC-Dev/aoscpt/commit/9160c245c3707ec42317b2fc5ed1ff544c86fd02))
    - If get ARCH run dpkg to failed, error missing context ([`c28196a`](https://github.com/AOSC-Dev/aoscpt/commit/c28196a4ec2c6b2163cecdfa4a4b16c05567228d))
    - If can not get ARCH, error missing context ([`14bdbd5`](https://github.com/AOSC-Dev/aoscpt/commit/14bdbd54600312b2a5e1427ab4180487a599b8a8))
    - Use dpkg --print-architecture to get arch name ([`5dbd68f`](https://github.com/AOSC-Dev/aoscpt/commit/5dbd68f501cb6a5b4ce1c588ef7bc915a17224b0))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.25.0 ([`e94b869`](https://github.com/AOSC-Dev/aoscpt/commit/e94b86904adec94380a81601e7ddce10b69a02b7))
    - Update all deps ([`59b43f4`](https://github.com/AOSC-Dev/aoscpt/commit/59b43f41c1c3b0cf46a76abe5aa3fa371fed41dd))
    - Support mips64r6el arch ([`9e0fc75`](https://github.com/AOSC-Dev/aoscpt/commit/9e0fc75bcf605e68a40ef2217781080fd8a46682))
    - Repeated version flag to run build.rs script to failed ([`659140f`](https://github.com/AOSC-Dev/aoscpt/commit/659140f65b9b49330ad34c0a5190d5f89ed6fd27))
    - Capitalise first letter of project description ([`696cfff`](https://github.com/AOSC-Dev/aoscpt/commit/696cfff46b2836cc1581cb92298f0159e4801b33))
    - Missing --version (-v, -V) help message ([`fea7d1c`](https://github.com/AOSC-Dev/aoscpt/commit/fea7d1ca3fa38be845bcabfa68fccd4598440846))
    - Support oma -v to display oma version ([`ce1a68b`](https://github.com/AOSC-Dev/aoscpt/commit/ce1a68bc427e0c17e1d88803527ecea62cf64e48))
</details>
 ...
 * **Uncategorized**
    - Bump oma v0.24.3 ([`97907fa`](https://github.com/AOSC-Dev/aoscpt/commit/97907fa6dacf186e9b19c620f0b64ba2cc6712e4))
